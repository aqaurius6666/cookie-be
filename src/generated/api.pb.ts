...
export class CookieService {
  ...
  static CreatePosts(req: CreatePostsRequest, initReq?: fm.InitReq): Promise<CreatePostsResponse> {
    return fm.fetchReq<CreatePostsRequest, CreatePostsResponse>(`/posts`, {...initReq, method: "POST", body: JSON.stringify(req, fm.replacer)})
  }
  static UpdatePost(req: UpdatePostRequest, initReq?: fm.InitReq): Promise<UpdatePostResponse> {
    return fm.fetchReq<UpdatePostRequest, UpdatePostResponse>(`/posts/${req["id"]}`, {...initReq, method: "PUT", body: JSON.stringify(req, fm.replacer)})
  }
  static ListPosts(req: ListPostsRequest, initReq?: fm.InitReq): Promise<ListPostsResponse> {
    return fm.fetchReq<ListPostsRequest, ListPostsResponse>(`/posts?${fm.renderURLSearchParams(req, [])}`, {...initReq, method: "GET"})
  }
  static GetUploadUrl(req: GetUploadUrlRequest, initReq?: fm.InitReq): Promise<GetUploadUrlResponse> {
    return fm.fetchReq<GetUploadUrlRequest, GetUploadUrlResponse>(`/upload/presigned-upload`, {...initReq, method: "POST", body: JSON.stringify(req, fm.replacer)})
  }
}